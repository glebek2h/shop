...
export const UPDATE_PROFILE_INFO_SUCCESS = `[Profile Change Info] Update Profile Info Success`
export const REMOVE_PROFILE_AVATAR = `[Profile Change Info] Remove Profile Avatar`
