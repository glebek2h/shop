...
export const categoryTechniques = 'CATALOG.TECHNIQUES';
export const categoryRepair = 'CATALOG.EQUIPMENT';
export const categoryHome = 'CATALOG.HOME';
export const categoryCar = 'CATALOG.CAR';
export const categorySport = 'CATALOG.SPORT';
